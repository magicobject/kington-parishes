...
// The thirteen pages in the primary header nav.
export const NAV_PAGES: SitePage[] = [
  ...
  { path: '/vacancies.html', navLabel: 'Vacancies', titleContains: 'Vacancies', heading: /current vacancies/i },
  { path: '/resources.html', navLabel: 'Resources', titleContains: 'Resources', heading: /explore or grow in faith/i },
...
export const HELP_PAGES: SitePage[] = [
  ...
  { path: '/help-dns-setup.html', navLabel: 'DNS setup', titleContains: 'DNS Setup', heading: /dns setup, in detail/i },
