...
Each church has its own portal page (`church-kington.html`, `church-titley.html`, `church-old-radnor.html`, `church-kinnerton.html`, `church-huntington.html`) linked from a "Visit the ... page →" link in that church's `.links-row` on `our-churches.html`. Not in the primary nav — reachable only from there, same pattern as Donate/Parish News Archive.
